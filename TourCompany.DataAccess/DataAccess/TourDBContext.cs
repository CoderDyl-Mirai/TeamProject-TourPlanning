    ...
    public class TourDBContext : IdentityDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Tour>()
                ...
                new Tour { Id = 14, Name = "Kylemore Abbey", Description = "Nestled in the heart of Connemara, on the Wild Atlantic Way, Kylemore Abbey is a haven of history, beauty and serenity. Home to a Benedictine order of Nuns for the past 100 years, Kylemore Abbey welcomes visitors from all over the world each year to embrace the magic of the magnificent 1,000-acre estate.", Price = 14.00m, Image = @"\Images\Tours\Kylemore.jpg", MaxCapacity = 20, MinCapacity = 1, Duration = 180, Location = "Galway" },
                new Tour { Id = 15, Name = "Connemara Park", Description = "Experience Connemara National Park on a full-day walking tour with a local guide. Covering 2,000 hectares of mountains, bogs, and woodlands in Galway, you’ll explore the Twelve Bens range, including Benbaun and Bencullagh. Discover the area’s natural beauty, history, and unique landscapes.", Price = 30.00m, Image = @"\Images\Tours\Connemara.jpg", MaxCapacity = 30, MinCapacity = 10, Duration = 480, Location = "Galway" }
            );
